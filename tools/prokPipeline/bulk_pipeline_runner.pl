...
# Note that project_name is uppercased.
    ...
    unless ( -e $proj_dir ) {
        ...
        mkpath $proj_dir || die "Couldn't create project directory $proj_dir : $!\n";
...
# There is no check that the fasta file is actually a fasta file.
    ...
    unless ( -e $fasta_dir_path ) {
        ...
        mkpath $fasta_dir_path or die "Can't create $fasta_dir_path: $!\n";
...
# where db_name is lowercase project_name
    ...
    unless ( -e $sqlite_dir ) {
        ...
        mkpath $sqlite_dir || die "Can't create $sqlite_dir: $!\n";
